...
public class Sistema extends javax.swing.JFrame {
    ...
    private void btnVerificarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarClienteActionPerformed
        ...
        if (cliente != null) {
            ...
            // Habilitar calendarios y bot�n de reservar
    ...
    private void btnReservarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReservarActionPerformed
        ...
        // Buscar habitaci�n seleccionada
        ...
        if (numeroSeleccionado == null) {
            JOptionPane.showMessageDialog(this, "Seleccione una habitaci�n.");
            return;
        }
        ...
        if (habitacion == null) {
            JOptionPane.showMessageDialog(this, "Habitaci�n no encontrada: " + numeroSeleccionado);
            return;
        }

        if (!habitacion.isEstado()) {
            JOptionPane.showMessageDialog(this, "La habitaci�n ya est� ocupada.");
            return;
        }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (clienteService.buscarPorDNI(dni) != null) {
            JOptionPane.showMessageDialog(this, "⚠�? El cliente con ese DNI ya está registrado.");
            return;
        }
    ...
    private void btnCancelarReservaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarReservaActionPerformed
        ...
        if (!estado.equalsIgnoreCase("Activa")) {
            JOptionPane.showMessageDialog(this, "⚠�? Solo se pueden cancelar reservas activas.");
            return;
        }
    ...
    private void btnBuscarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarFacturaActionPerformed
        ...
        if (seleccionado == null || !seleccionado.contains(" - ")) {
            JOptionPane.showMessageDialog(this, "?? Selecciona un cliente v�lido.");
            return;
        }
    ...
    private void btnGenerarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarFacturaActionPerformed
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Ocurri� un error al generar la factura.");
        }
    ...
    private void btnCancelarResActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarResActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Operaci�n cancelada. Formulario restaurado.");
